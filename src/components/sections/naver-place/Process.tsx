...
const steps = [
    {
        ...
        title: "상담 및 견적 확인",
        description:
            "홍보가 필요한 서비스 종류, 타겟 지역 등 구매자 측이 희망하는 요소를 파악하고 그에 맞는 마케팅 방법을 제시합니다.",
        color: "from-[#2DB400] to-[#1EC800]",
    },
    {
        number: 2,
        icon: FileEdit,
        title: "초안 검토 및 수정",
        description:
            "구매자 측에서 준비한 원고를 바탕으로 네이버 플레이스의 분위기와 감성에 맞게 수정하는 절차를 거칩니다. 구매자 측의 확인이 완료되면 최종원고가 확정됩니다.",
        color: "from-[#1EC800] to-[#00C73C]",
    },
    {
        number: 3,
        icon: Upload,
            ...
            <div className='container mx-auto px-4'>
                ...
                <div className='max-w-5xl mx-auto'>
                    <div className='relative'>
                        ...
                        <motion.div
                            className='absolute left-[45px] top-0 w-1 bg-gradient-to-b from-[#2DB400] to-[#E5F7FF] origin-top sm:left-1/2 sm:-ml-[2px]'
                            style={{
