                        ...
                        >
                            <Card className='p-6 relative h-full hover:shadow-lg transition-shadow duration-300'>
                                <div className='flex flex-col h-full'>
                                    {/* Number Badge */}
                                    <div className='absolute -top-4 left-6 w-8 h-8 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center text-white font-bold'>
                                        {step.number}
                                    </div>

                                    {/* Icon */}
                                    <div className={`w-12 h-12 rounded-lg bg-gradient-to-r ${step.color} flex items-center justify-center mb-4 mt-2`}>
