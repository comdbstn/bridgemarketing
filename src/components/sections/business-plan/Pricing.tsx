    ...
    const services: Services = {
        "정부지원사업계획서": [
            ...
            },
            {
                name: "사업계획서 피드백",
                price: "10만원 내외",
                description: "비대면 컨설팅을 통한 간단한 피드백이 필요하신 분들을 위한 상품",
                features: [
                    "초안 작성부터 방향성 감이 안 잡히시는 분",
                    "초안은 작성했지만, 정부의 입맛대로 작성했는지 확인이 필요하신 분",
                    "완성본을 작성했고, 최종 점검을 받고 싶으신 분",
                    "비대면 컨설팅 1회 제공",
                    "문서 피드백 제공"
                ]
            },
            {
                name: "최종 제출 전 양식 점검",
                price: "10만원 내외",
                description: "최종 제출 전 양식을 통일성 있게 편집하고 싶으신 분들을 위한 상품",
                features: [
                    "최종 제출하실 사업계획서 또는 IR에 대한 양식 편집",
                    "15장 기준 작업 진행",
                    "통일성 있는 디자인 적용",
                    "가독성 향상을 위한 레이아웃 조정",
                    "문서 품질 개선"
