        ...
        <section className="py-24 relative overflow-hidden bg-gradient-to-br from-purple-50 to-white">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <motion.div
                    ...
                    className="mb-12"
                >
                    <span className="text-purple-600 font-semibold text-lg font-tway mb-6 block">
                        BUSINESS PLAN SERVICE
                    </span>
                    <h2 className="text-[3.5rem] leading-tight font-bold mb-6 font-aggro bg-gradient-to-r from-purple-600 to-purple-400 bg-clip-text text-transparent">
                        사업계획서 작성 서비스
                    </h2>
                </motion.div>
                ...
                >
                    <p className="text-2xl text-gray-700 font-tway leading-relaxed mb-10">
                        ...
                        <br />
                        <span className="text-purple-600 font-semibold">맞춤형 사업계획서를 작성</span>해드립니다.
                    </p>
                    
                    <div className="space-y-6">
                        <div className="flex items-center text-gray-700 group">
                            <ArrowRight className="w-6 h-6 text-purple-500 mr-3 group-hover:translate-x-1 transition-transform" />
